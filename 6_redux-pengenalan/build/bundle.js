...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionCreators = __webpack_require__(23);
	...
	function counter() {
		...
		switch (action.type) {
			...
			case 'CHANGE_SCHOOL':
				return Object.assign({}, state, { school: [].concat(_toConsumableArray(state.school), [action.school]) }); //Array in state object must not be mutated
	...
	store.subscribe(function () {
		return document.write('current state, age: ' + store.getState().age + ', name: ' + store.getState().name + ', school: ' + store.getState().school.join(', ') + '<br/>');
	});

	//DISPATCH EXAMPLES
	store.dispatch((0, _actionCreators.changeName)('baby'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeName)('toddler'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeSchool)('TK'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeSchool)('SD'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeName)('preteen'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeName)('teens'));
	store.dispatch((0, _actionCreators.changeSchool)('SMP'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeSchool)('SMA'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeSchool)('Kul'));
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.addAge)());
	store.dispatch((0, _actionCreators.changeName)('young adult'));
...
/***/ function(module, exports) {
	...
	*/
	...
	var CHANGE_SCHOOL = 'CHANGE_SCHOOL';
	...
	*/
	...
	var changeSchool = function changeSchool(school) {
		return { type: CHANGE_SCHOOL, school: school };
	};
